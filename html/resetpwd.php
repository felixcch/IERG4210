...
<div class="container">
    <div class="card card-container">
        ...
        <form  id ="login" class="form-signin" method="POST" action="lib/auth-process.php?action=<?php $action = 'resetpwd'; echo $action?>" onsubmit="return false" enctype="multipart/form-data">
